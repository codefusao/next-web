	...
	return (
		<>
			...
			{isDepartmentModalOpen ? (
				...
				>
					<form
						onSubmit={departmentForm.handleSubmit(createDepartment)}
						noValidate
						className="mt-6"
					>
						<label className="block">
							...
							<input
								...
								className="mt-2 h-[var(--control-height-input)] w-full rounded-[var(--radius-control)] border-[1.5px] border-border bg-background px-3.5 text-[15px] text-foreground outline-none focus:border-primary"
								aria-invalid={Boolean(departmentForm.formState.errors.name)}
							/>
